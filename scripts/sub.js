...
function findAutoSubstitution(przedmiot, zastepca, odwolane, przeniesienie) {
    // Jeśli nie ma zastępcy i nie jest odwołane/przeniesione, wyświetl informację o zmianie sali
    if (!zastepca && !odwolane && !przeniesienie) {
        return "Uwaga! Zmiana w przydziale sali";
    }
    return null;
}
